...
const TestSuite = require('../models/TestCaseExecution');
const TestCase = require('../models/TestCase');

// Get all test suite executions (optionally filter by project)
...
// Get a single test suite execution
...
// Create a new test suite execution
const createTestSuite = asyncHandler(async (req, res) => {
  const { test_suite_name, project_id, status, start_date, end_date, bug_id, executed_by, executed_date, assigned_to_user_id, remarks, test_case_ids } = req.body;
